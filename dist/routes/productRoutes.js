        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            if (newProduct) {
              ...
              res.status(500).send({
                msg: "Error in creating new products. "
              });
            }
...
router.put("/:id/updateStock", /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(req, res) {
    var product, newStock, updatedProduct;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            newStock = product.stock - Number(req.body.qty);
          ...
          case 8:
            ...
            if (updatedProduct) {
              ...
              res.status(500).send({
                msg: "Error in updating product's stock. "
              });
            }
